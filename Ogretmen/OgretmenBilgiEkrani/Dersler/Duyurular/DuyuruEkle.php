...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO duyurular (Ders_id, aciklama, aciklama_saati, dosya_id, baslik) VALUES (?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("issis", $ders_id, $aciklama, $aciklama_saati, $dosya_id, $baslik);
    $stmt->execute();
                ...
                <div class="shortcut-container p-3 text-center">
                    ...
                    <div class="shortcuts d-flex flex-wrap p-3 text-center justify-content-center">
                        <div class="container mt-5">
                            <form action="duyuruEkle.php?dersid=<?php echo $ders_id; ?>" method="POST" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <label for="baslik" class="col-sm-2 col-form-label">Başlık</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="baslik" name="baslik" placeholder="Başlık Giriniz...">
                                    </div>
                                </div>
